...
stocks.boxList = [
    ['Maža dėžutė', 1165008631, 400000, -0.12, true, 10000, 'Standartas', -1], //0
    ['Vidutinė dėžutė', 1875981008, 600000, -0.12, true, 20000, 'Standartas', -1], //1
    ['Didelė dėžutė', -1322183878, 800000, -0.12, true, 30000, 'Standartas', -1], //2

    ['Didelė ginklų dėžė', 1790162299, 3, 0, false, 80000, 'Ginklai ir šaudmenys', 1], //3
    ['Maža ginklų dėžė', 2055492359, 4, 0, false, 30000, 'Ginklai ir šaudmenys', 0], //4
    ['Didelė dėžė antikvariatų', 1815664890, 5, 0, false, 15000, 'Antikvariatas', 1], //5
    ['Maža dėžė antikvariatų', 1397410834, 5, 0, false, 5000, 'Antikvariatas', 0], //6
    ['Didelė dėžė antikvariatų', 1057918179, 6, 0, false, 15000, 'Antikvariatas', 1], //7
    ['Maža dėžė antikvariatų', -1655753417, 7, 0, false, 5000, 'Antikvariatas', 0 ], //8
    ['Didelė dėžė chemikalų', 21331302, 8, 0, false, 15000, 'Chemikalai', 1 ], //9
    ['Maža dėžė chemikalų', 1075102988, 9, 0, false, 5000, 'Chemikalai', 0 ], //10
    ['Didelė dėžė sidabro', 2014503631, 10, 0, false, 15000, 'Padirbtos prekės', 1 ], //11
    ['Maža dėžė sidabro', -333302011, 11, 0, false, 5000, 'Padirbtos prekės', 0 ], //12
    ['Maža dėžė medikamentų', 2092857693, 12, 0, false, 5000, 'Medikamentai', 0 ], //13
    ['Cigarečių Redwood dėžė', -1958, 14, 0, false, 5000, 'Alkoholis ir tabakas', 0 ], //14
    ['Cigarečių Redwood dėžė', -1958, 14, 0, false, 5000, 'Alkoholis ir tabakas', 0 ], //15
    ['Didelė dėžė odinių krepšių', 12824223, 15, 0, false, 15000, 'Brakonieriaus trofėjai', 1 ], //16
    ['Maža dėžė odinių krepčių', -270239139, 16, 0, false, 5000, 'Brakonieriaus trofėjai', 0 ], //17
    ['Didelė dėžė technikos', 60045683, 17, 0, false, 15000, 'Padirbtos prekės', 1 ], //18
    ['Maža dėžė technikos', -731494164, 18, 0, false, 5000, 'Padirbtos prekės', 0 ], //19
    ['Didelė dėžė sprogmenų', -1853019218, 19, 0, false, 15000, 'Ginklai ir šaudmenys', 1 ], //20
    ['Maža dėžė sprogmenų', -305076648, 20, 0, false, 5000, 'Ginklai ir šaudmenys', 0 ], //21
    ['Reti filmai', 725420132, 21, 0, false, 30000, 'Unikalus krovinys', 2 ], //22
    ['Didelė dėžė kailinių paltų', -1227143673, 22, -0.12, false, 15000, 'Brakonieriaus trofėjai', 1 ], //23
    ['Maža dėžė kailinių paltų', 1915002422, 23, -0.12, false, 5000, 'Brakonieriaus trofėjai', 0 ], //24
    ['Didelė dėžė brangakmenių', 654562429, 24, 0, false, 15000, 'Juvelyriniai dirbiniai', 1 ], //25
    ['Maža dėžė brangakmenių', 304821544, 25, 0, false, 5000, 'Juvelyriniai dirbiniai', 0 ], //26
    ['Didelė dėžė vaistų', -1129076059, 26, 0, false, 15000, 'Medikamentai', 1 ], //27
    ['Maža dėžė vaistų', 1524744766, 27, 0, false, 5000, 'Medikamentai', 0 ], //28
    ['Didelė dėžė papuošalų', -76137332, 28, 0, false, 15000, 'Juvelyriniai dirbiniai', 1 ], //29
    ['Maža dėžė papuošalų', -290560280, 29, 0, false, 5000, 'Juvelyriniai dirbiniai', 0 ], //30
    ['Didelė dėžė su laikrodžiais', -1817226762, 30, 0, false, 15000, 'Juvelyriniai dirbiniai', 1 ], //31
    ['Maža dėžė su laikrodžiais', -2104190829, 31, 0, false, 5000, 'Juvelyriniai dirbiniai', 0 ], //32
    ['Didelė dėžė vaistų', 797797701, 32, 0, false, 15000, 'Medikamentai', 1 ], //33
    ['Maža dėžė vaistų', 1054352436, 33, 0, false, 5000, 'Medikamentai', 0 ], //34
    ['Auksinis Minigun', 1557324266, 34, 0, false, 40000, 'Unikalus krovinys', 2 ], //35
    ['Didelė dėžė padirbtų banknotų', -80652213, 35, 0, false, 15000, 'Padirbtos prekės', 1 ], //36
    ['Maža dėžė padirbtų banknotų', -1155316904, 36, 0, false, 5000, 'Padirbtos prekės', 0 ], //37
    ['Didelė dėžė narkotikų', 1016837103, 37, 0, false, 40000, 'Narkotikai', 1 ], //38
    ['Maža dėžė narkotikų', 1863514296, 38, 0, false, 20000, 'Narkotikai', 0 ], //39
    ['Faberže kiaušinis', 562429577, 39, 0, false, 35000, 'Unikalus krovinys', 2 ], //40
    ['Didelė dėžė vaistų', 1914690987, 40, -0.12, false, 15000, 'Medikamentai', 1 ], //41
    ['Maža dėžė vaistų', -824154829, 41, 0, false, 5000, 'Medikamentai', 0 ], //42
    ['ETTI kostiumas', -495810123, 42, 0, false, 25000, 'Unikalus krovinys', 2 ], //43
    ['Didelė dėžė alkoholio ir tabako', -19283505, 43, -0.12, false, 15000, 'Alkoholis ir tabakas', 1 ], //44
    ['Maža dėžė alkoholio ir tabako', -2073232532, 44, -0.12, false, 5000, 'Alkoholis ir tabakas', 0 ], //45
    ['Auksinis kompasas', 577983279, 45, 0, false, 35000, 'Unikalus krovinys', 2 ], //46
    ['Didelė dėžė dramblio ilčių', -2033482115, 46, -0.12, false, 15000, 'Brakonieriaus trofėjai', 1 ], //47
    ['Maža dėžė dramblio ilčių', 588496643, 47, -0.12, false, 5000, 'Brakonieriaus trofėjai', 0 ], //48
    ['64 karatų briliantas', 926762619, 48, 0, false, 50000, 'Unikalus krovinys', 2 ], //49
    ['MerryWeather ginklų dėžė', -994309865, 49, 0, false, 100000, 'Ginklai ir šaudmenys', 2 ], //50
    ['Dėžė su Fleeca banko dokumentais', -994309865, 50, 0, false, 100000, 'Unikalus krovinys', 3 ], //51
    ['Dėžė su C4', -1853019218, 51, 0, false, 200000, 'Ginklai ir šaudmenys', 3 ], //52
    ['Dėžė su Pacific banko dokumentais', -994309865, 50, 0, false, 200000, 'Unikalus krovinys', 3 ], //53
];
    ...
    mysql.executeQuery(`SELECT * FROM stocks`, function (err, rows, fields) {
        rows.forEach(function(item) {
            ...
            try {
                ...
                methods.createCp(hBlip.pos.x, hBlip.pos.y, hBlip.pos.z, "Paspauskite ~g~Е~s~ jog atidarytumėte meniu");
...
stocks.loadLast = function() {
    ...
    mysql.executeQuery(`SELECT * FROM stocks ORDER BY id DESC LIMIT 1`, function (err, rows, fields) {
        ...
        rows.forEach(function(item) {
            ...
            methods.createCp(hBlip.pos.x, hBlip.pos.y, hBlip.pos.z, "Paspauskite ~g~Е~s~ jog atidarytumėte meniu");
            chat.sendToAll(`Pridėto sandėlio ID: ${item['id']}. Name: ${item['number']}. Int: ${item['interior']}. Price: ${methods.moneyFormat(item['price'])}`);

            let id = item['id'];
            discord.sendMarketProperty(`Sandėlys #${stocks.get(id, 'number')}`, `Adresas: ${stocks.get(id, 'address')} / ${stocks.get(id, 'street')} #${stocks.get(id, 'number')}\nValstybinė kaina: ${methods.moneyFormat(stocks.get(id, 'price'))}\nTipas: ${stocks.types[stocks.get(id, 'interior')]}`);
...
stocks.insert2 = function(player, id, vx, vy, vz, vrot) {
    ...
    player.notify('~g~Sandelis sėkmingai atnaujintas')
};
...
stocks.cargoUnload = function(player, bid = 1) {
    ...
    try {
        ...
        if (boxes[bid] === -1 || boxes[bid] === undefined || boxes[bid] === null) {
            player.notify('~r~Transportas yra tuscias');
            return;
        }
        ...
        if (stockKey) {
            ...
            if (houseData.get('user_id') != 0) {
                ...
                if (countLoad > 0)
                    player.notify(`~g~Iskrovete deže`);
                else
                    player.notify(`~r~Sandelyje neužtenka vietos`);
            }
        }
        else if (methods.distanceToPos(player.position, new mp.Vector3(585.6728515625, 2790.1337890625, 41.18254470825195)) < 8)
        {
            ...
            if (box && fId > 0) {
                ...
                methods.saveFractionLog(
                    ...
                    `Iškrovė dėžę ${stocks.boxList[box][0]}`,
                    `Biudžeto papildymas: ${methods.moneyFormat(stocks.boxList[box][5])}`,
                    fId
                );
            }
            player.notify(`~g~Iskrovete deže`);
        ...
        {
            player.notify('~r~Reikia buti netoli sandelio');
        }
    }
    catch (e) {
...
stocks.sellBySlot = function (player, slot) {
    ...
    if (stocks.boxList[box][7] < 0) {
        user.addMoney(player, boxPrice, 'Pardavimas ' + stocks.boxList[box][0]);
        player.notify(`~g~Jus pardavete ${stocks.boxList[box][0]}. Pinigai buvo iskaityti i jusu pinigine`);
    }
    else {
        if (user.get(player, 'fraction_id2') > 0) {
            user.addCryptoMoney(player, boxPrice / 2, 'Pardavimas ' + stocks.boxList[box][0]);
            fraction.addMoney(user.get(player, 'fraction_id2'), boxPrice / 2, 'Krovinį parduoda ' + user.getRpName(player));
            player.notify(`~g~Jus pardavete ${stocks.boxList[box][0]}. Pinigai buvo iskaityti i jusu BitCoin pinigine. 50 % pervedama i organizacijos bendraji fonda`);
        }
        else {
            user.addCryptoMoney(player, boxPrice, 'Pardavimas ' + stocks.boxList[box][0]);
            player.notify(`~g~Jus pardavete ${stocks.boxList[box][0]}. Pinigai buvo iskaityti i jusu BitCoin pinigine`);
        }
    }
};
...
stocks.openBySlot = function (player, slot, boxId) {
    ...
    stocks.openCase[boxId][caseId].forEach(async item => {
        setTimeout(function () {
            if (boxId === 51)
            {
                inventory.addItem(item, 1, slot + inventory.types.UserStock, id + enums.offsets.stock, 1, 0, "{\"desc\":\"Fleeca banko tvarkaraštis\",\"type\":1}", 1);
            }
            else if (boxId === 53)
            {
                if (item === 474)
                    ...
                    inventory.addItem(item, 1, slot + inventory.types.UserStock, id + enums.offsets.stock, 1, 0, "{\"desc\":\"Pacific banko tvarkaraštis\",\"type\":2}", 2);
            }
            else
    ...
    player.notify(`~g~Jus atidarete deže`);
};
...
stocks.sellAllByClass = function (player, className, price) {
    ...
    if (user.get(player, 'fraction_id2') > 0) {
        user.addCryptoMoney(player, price / 2, 'Pardavimas ' + className);
        fraction.addMoney(user.get(player, 'fraction_id2'), price / 2, 'Krovinį pardavė ' + user.getRpName(player));
        player.notify(`~g~Jus pardavete ${className}. Pinigai buvo iskaityti i jusu BitCoin pinigine. 50 % pervedama i organizacijos bendraji fonda`);
    }
    else {
        user.addCryptoMoney(player, price, 'Pardavimas ' + className);
        player.notify(`~g~Jus pardavete ${className}. Pinigai buvo iskaityti i jusu BitCoin pinigine`);
    }
};
...
stocks.upgradeAdd = function(player, id, slot, boxId) {
    ...
    if (boxPrice > user.getBankMoney(player)) {
        player.notify('~r~Jusu saskaitoje nepakanka lesu');
        return;
    }
    ...
    user.removeBankMoney(player, boxPrice, 'Dėžių pirkimas sandėlyje');

    stocks.addObject(boxId, slot, id, stocks.get(id, 'interior'));

    player.notify('~g~Sveikiname nusipirkus');
};
...
stocks.sell = function (player) {
    ...
    if (hInfo.get('user_id') != user.get(player, 'id')) {
        player.notify('~r~Sis sandelys jums nepriklauso');
        return;
    }
    ...
    user.addMoney(player, nalog, 'Sandėlio pardavimas ' + hInfo.get('address') + ' №' + hInfo.get('number'));

    setTimeout(function () {
        if (!user.isLogin(player))
            return;
        user.addHistory(player, 3, 'Pardavė sandėlį ' + hInfo.get('address') + ' №' + hInfo.get('number') + '. Kaina: ' + methods.moneyFormat(nalog));
        player.notify(`~g~Jus pardavete nekilnojamaji turta\nMokestis:~s~ ${coffer.getTaxProperty()}%\n~g~Gauta:~s~ ${methods.moneyFormat(nalog)}`);
        user.save(player);
    }, 1000);
};
...
stocks.buy = function (player, id) {
    ...
    user.removeMoney(player, hInfo.get('price'), 'Sandėlio pirkimas ' + hInfo.get('address') + ' №' + hInfo.get('number'));
    setTimeout(function () {
        if (!user.isLogin(player))
            return;
        user.addHistory(player, 3, 'Nusipirko sandėlį ' + hInfo.get('address') + ' №' + hInfo.get('number') + '. Kaina: ' + methods.moneyFormat(hInfo.get('price')));
        user.save(player);
...
stocks.enterv = function (player, id) {
    ...
    if (vehicles.exists(player.vehicle)) {
        ...
        {
            player.notify('~r~Sios klasės automobiliams draudžiama ivažiuoti i garaža');
            return;
        }

        if (player.vehicle.getVariable('cargoId'))
        {
            player.notify('~r~I garaža draudžiama ivažiuoti transporto priemonems su kroviniu');
            return;
        }
